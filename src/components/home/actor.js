...
state = { visibleComponent: false,checked: false,movie: [] }
...
<Post name="all movies" link="/movie/single/" elements={this.state.movie}></Post>

<Links name="Tags" path="/movie/tag/" elements={tags}/>
